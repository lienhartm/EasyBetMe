<div class="points">
    ...
    <div class="bloc" id="position" onclick="document.location.href='<?=$link;?>';">
        ...
        <? else: ?>
        <p>Vous n'avez pas encore marqué de point pour vous classer</p>
        <? endif; ?>
    </div>
...
<? $link = $Url.'/'.$page.'/pronos'; ?>
    <div class="bloc" id="pronos" onclick="document.location.href='<?=$link;?>';">
        ...
        <p class="icon">&#xe939;</p>
        <p class="main"><a href="<?=$link;?>"><strong><?=$nbPronos;?></strong></a></p>
    </div>
