...
/*
$Games = $db->prepare('INSERT INTO easybet_games WHERE id = ? AND id_domicile = ? AND id_visiteur = ?');
...
if($nbCheck >= 0) {
    ...
    $sql = 'INSERT INTO easybet_bets (id, `date`, id_game, id_user, score_d, score_v, bet) VALUES ("", "'.$date.'", '.$id_game.', '.$User['id'].', '.$sd.', '.$sv.', "'.$bet.'")';
