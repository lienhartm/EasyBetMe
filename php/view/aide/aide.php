<!-- feuille de style aide.css -->
<link href="../styles/_aide.css" rel="stylesheet" type="text/css" />
...
<p>
    ...
    <strong>un seul pronostic par jour</strong>
    . Une fois le pronostic effectué, il n'est plus possible de le modifier. 
    Les pronostics sont ouverts jusqu'à la dernière minute avant le début de l'événement. 
    Une fois l'événement commencé, il n'est plus possible de faire un pronostic. 
    Il est possible de faire un pronostic par jour. 3 points de victoire sont attribués si le score prédit est exact, 
    1 point si l'issue du jeu a été trouvée (victoire de l'équipe à domicile, des visiteurs ou match nul). 
    Un délai d'attente de 80 heures après le début de la rencontre est recommandé par le jury pour l'attribution des points si le pari est gagné.
    Les points servent à vous classer parmis les joueurs et tenter de remporter des lots. 
    Rendez-vous sur la <!--<a href="<?=$Url;?>/points">page points</a>--> pour connaître votre position et le(s) lot(s) actuel(s).
</p>
<br />
...
<p>
    ...
    Concernant le gameplay, l’objectif principal de ce jeu est de marquer des buts en un nombre d’essais donné. 
    Il n’y a pas de limite de temps, il suffit de bien ajuster la position du ballon et la puissance du tir. 
    Le joueur doit contrôler la barre avec le curseur de la touche 'space' et appuyer sur la touche 'space' pour tirer.
</p>
<p>
    Ce mini-jeu de pénaltys est un jeu d'adresse où les joueurs peuvent gagné des crédits en tirant des pénaltys. 
    A chaque partie le joueur dispose de 5 tirs, et le but est de marquer le plus de buts possible. 
    Le score est ensuite crédité sur votre compte de tel sorte :
</p>
<ul>
...
<p class="titleAide">Capture d'écran du Mini-jeu de pénalty</p>
<br />
<br />
<p>
    Tout est très simple. Il suffit d’utiliser la touche 'space' pour viser et d'appuyer pour tirer. 
    Ce jeu de sport est codé entièrement en JavaScript. Toutes les fonctionnalités du jeu sont implémentées en JavaScript, 
    tandis que HTML et CSS sont utilisés pour la structure et le design. Des images et fichiers audio sont intégrés pour améliorer les graphismes et l’expérience de jeu.
</p>
<p>
    Nous recommandons d’utiliser des navigateurs modernes comme Google Chrome ou Mozilla Firefox. 
    Le jeu peut également fonctionner sur Internet Explorer ou Microsoft Edge.
    <br />
    Le projet Penalty Shootout Game en JavaScript avec code source est gratuit à télécharger et à utiliser uniquement à des fins éducatives.
</p>
<br />
<a class="retour"  href="#easybet">⟰ Retour</a>
<br />
...
<ul>
    <br />
    <li class="underline">V.i Présentation</li>
    <p>
        <strong><?=ucfirst($Site['nom']);?></strong>&nbsp;
    ...
    <br />
    <br />
    <li class="underline">V.ii Événements</li>
    <p>
    ...
    <br />
    <br />
    <li class="underline">V.iii Aide</li>
    <p>
    ...
    <br />
    <br />
    <li class="underline">V.iv Administration</li>
    ...
    <br />
    <br />
    <li class="underline">V.v Conclusion</li>
    <p>
...
<br />
<p>
    Vous pouvez toujours nous contactez pour nous apportez votre soutien au projet&nbsp;
    <strong><?=ucfirst($Site['nom']);?></strong>
    &nbsp;en écrivant par courriel à l'addresse suivante : contact@easybet.me
</p>
<br />
<br />
<br />
